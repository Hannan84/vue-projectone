...
const images = [
  {
    ...
    title: "Surrounded by trees and mountains",
  ...
  <section class="container mx-auto p-10">
    ...
    <section class="main flex space-x-4">
      <div class="flex space-y-4 flex-col w-1/2">
        <img :title="images[0].title" v-bind:src="images[0].image" alt="" />
      ...
      <div class="flex space-y-4 flex-col w-1/2">
        <img :title="images[1].title" :src="images[1].image" alt="" />
        <h2 class="text-xl text-left">
          {{ images[1].title }}
        </h2>
        <a
      ...
      <div class="flex space-y-4 flex-col w-1/2">
        <img :title="images[2].title" v-bind:src="images[2].image" alt="" />
        <h2 class="text-xl text-left">
          {{ images[2].title }}
        </h2>
        <a
